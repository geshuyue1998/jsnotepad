...
var $dlgGoto=(function(){
    var $dlg=$(''
      +'<div class="notepad-goto-dlg">'         
        +'<div class="box">'                
          +'<div class="titlebar">'                        
            +'<p>转到指定行</p>'                                                                                     +'<span class="btn-close">×</span>'                        
          +'</div>'                                                 
          +'<div class="main">'                                 
            +'<label for="" class="num">行号(L):</label><br>'
            +'<input type="text" class="txt" autofocus><br>'                                                         +'<input type="button" class="goto" value="转到">'                                                       +'<input type="button" class="cancel" value="取消">'                                                   +'</div>'                                                                                              +'</div>'
      +'</div>'
   );
})
